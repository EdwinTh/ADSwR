...
Apparently, more often than not the plug is pulled before this stage is reached. 
...
As a result, stakeholders might lose interest and confidence in the successful completion of the project.
...
* *You will fail fast*. 
There is a wide array of reasons a data science project might fail; the business problem appears not be translatable into data science problem, data quality is low, there is not enough historical data, or the necessary relationships simply don't exist. 
...
Instead of meticulously describing how the job should be done, just set the goals of the projects and leave it up to the team how these goals are attained. 
...
It can happen that when business people get overly involved in the process, they can have a strong opinion on which predictors should be used or how the target should be defined or what the best way is to visualise something in a dashboard. 
...
Deploy products as early as possible, don't lose yourself in endless explorations.
