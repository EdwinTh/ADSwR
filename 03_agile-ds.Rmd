...
This principle comes natural to data science, since the success of a project typically dependent on the relationships discovered in data. 
...
Data scientis typically already enjoy this type of freedom for the sheer reason that stakeholders don't really understand how the products are built. 
...
Data might be made available by a DBA, a backender might expose the product at the website, the frontender builds the interface for interacting with predictions, etc. 
...
They promote a workflow of taking it easy at first, stressing out when the dealine comes near and exhaustion after it. 
...
Data cleaning, splitting in train and validation sets, running algorithms that produce the models, doing research on relationships in the data and many more steps are for the data scientist's eyes only. 
...
Instead of meticulously plan every aspect of the project upfront, let the developers come up with the most important project designs as they go. 
