...
This implies that by necessity aspects of data science projects experienced by others that I am not familiar with. 
...
Arttu Kosonen `@datarttu`, Colin Fay `@ColinFay`, Dilsher Singh Dhillon `@dshelldhillon`, Jesse Tweedle  `@tweed1e`, `@khailper`, Lorenz Walthert `@lorenzwalthert`, Maria Teresa Ortiz `@tereom`, Nathan Moore `@nmoorenz`, Nic Fox `@foxnic`, Paul van Leeuwen `@paulvanleeuwen`, `@YaraRAA`
