...
But everybody was interested in this "Big Data" thing, so quickly we started to do consulting work without a clear idea what I was going to do. 
...
I learned a great deal since these day, both from other's insights and from my own experiences. 
Writing an R package that to be shipped to CRAN enforced me to understand the basics of software engineering. 
...
Last year, for the first time, I joined a Scrum team (frontend, backend, ux designer, product owner, second data scientis) to create a machine learning model that we brought to production using the Agile principles. 
...
This means that if I were to write this text in isolation I would be "overfitting" the workflow on about the dozen large data science projects I have done. 
...
If you use python rather than R, you will still find this text valuable. 
Especially the first part, which focuses on workflow only and is tool agnostic. 
